...
type HttpResponseMessageAssertions =
    ...
    /// Asserts that the subject has the specified status code.
    [<Extension>]
    ...
    /// Asserts that the subject has a status code between 100 and 199.
    [<Extension>]
    ...
    /// Asserts that the subject has a status code between 200 and 299.
    [<Extension>]
    ...
    /// Asserts that the subject has a status code between 300 and 399.
    [<Extension>]
    ...
    /// Asserts that the subject has a status code between 400 and 499.
    [<Extension>]
    ...
    /// Asserts that the subject has a status code between 500 and 599.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 100 Continue.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 101 Switching Protocols.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 201 Created.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 202 Accepted.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 203 Non-Authoritative Information.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 204 No Content.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 205 Reset Content.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 206 Partial Content.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 300 Multiple Choices.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 301 Moved Permanently.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 302 Found.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 303 See Other.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 304 Not Modified.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 307 Temporary Redirect.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 308 Permanent Redirect.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 400 Bad Request.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 401 Unauthorized.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 403 Forbidden.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 404 Not Found.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 405 Method Not Allowed.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 406 Not Acceptable.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 407 Proxy Authentication Required.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 408 Request Timeout.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 409 Conflict.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 410 Gone.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 411 Length Required.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 412 Precondition Failed.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 413 Content Too Large.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 414 URI Too Long.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 415 Unsupported Media Type.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 416 Range Not Satisfiable.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 417 Expectation Failed.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 421 Misdirected Request.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 426 Upgrade Required.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 428 Precondition Required.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 429 Too Many Requests.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 431 Request Header Fields Too Large.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 451 Unavailable For Legal Reasons.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 500 Internal Server Error.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 501 Not Implemented.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 502 Bad Gateway.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 503 Service Unavailable.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 504 Gateway Timeout.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 505 HTTP Version Not Supported.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 506 Variant Also Negotiates.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 510 Not Extended.
    [<Extension>]
    ...
    /// Asserts that the subject has status code 511 Network Authentication Required.
    [<Extension>]
